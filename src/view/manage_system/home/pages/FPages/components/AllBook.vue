    ...
    <el-row :gutter="20">
      ...
      <el-col :span="4">
        <el-form-item label="书名" prop="book_name">
          <el-input v-model="ruleForm.book_name" autocomplete="off" />
        </el-form-item>
      </el-col>
      <el-col :span="4">
        <el-form-item label="作者" prop="autor">
          <el-input v-model="ruleForm.autor" />
        </el-form-item>
      </el-col>
      <el-col :span="4">
  ...
  <el-dialog v-model="dialogFormVisible" title="新增" width="500">
    <el-form :model="formModel">
      <el-form-item label="书名：" :label-width="formLabelWidth">
        <el-input v-model="formModel.bookName" autocomplete="off" />
      </el-form-item>
      <el-form-item label="作者：" :label-width="formLabelWidth">
        <el-input v-model="formModel.author" autocomplete="off" />
      </el-form-item>
      <el-form-item label="出版社：" :label-width="formLabelWidth">
        <el-input v-model="formModel.publish" autocomplete="off" />
      </el-form-item>
      <el-form-item label="语言：" :label-width="formLabelWidth">
        <el-input v-model="formModel.language" autocomplete="off" />
      </el-form-item>
      <el-form-item label="价格：" :label-width="formLabelWidth">
        <el-input v-model="formModel.price" autocomplete="off" />
      </el-form-item>
      <el-form-item label="库存：" :label-width="formLabelWidth">
        <el-input v-model="formModel.stock" autocomplete="off" />
      </el-form-item>
      <el-form-item label="简介：" :label-width="formLabelWidth">
        <el-input v-model="formModel.introduction" autocomplete="off" />
      </el-form-item>
      <el-form-item label="出版时间：" :label-width="formLabelWidth">
        <el-input v-model="formModel.publish_time" autocomplete="off" />
      </el-form-item>
      <el-form-item label="分类：" :label-width="formLabelWidth">
        <el-input v-model="formModel.book_class_id" autocomplete="off" />
      </el-form-item>
    </el-form>
    <template #footer>
...
const formLabelWidth = ref<number>(100)
